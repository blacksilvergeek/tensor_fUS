...
% ~xsfunc(options.Compression) || (islogical(options.Refinement) && ...
%         ~options.Refinement)


% (islogical(options.Refinement) && ...
%         ~options.Refinement)

% ~xsfunc(options.Compression)
% islogical(options.Refinement)
% ~options.Refinement
